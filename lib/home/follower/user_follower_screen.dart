                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(followersUserList[index]['username'] ?? "", style: boldTextStyleWhite_16),
                        Text(followersUserList[index]['name'], style: extraBoldTextStyleDarkGray_14.copyWith(color: colorLightWhite))
                      ],
                    )
                  ],
                ),
